...
export async function seedInitialData() {
  try {
    ...
    if (foodCount > 0) {
      console.log('[Seed] Database already has food items. Skipping initial seed.');
      return;
    }

    console.log('[Seed] Initializing FoodMap database with authentic sample vendors & food items...');

    // 1. Create or find Vendor User
    let vendorUser = await User.findOne({ phone: '+919820145892' });
    if (!vendorUser) {
      vendorUser = await User.create({
        phone: '+919820145892',
        name: 'Anjali Sharma',
        role: 'vendor',
        avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCcCn3i8k4gYk-jLV5MXuqSONW-8QpGOpQ4yYcs-5HUarOFUR1kCq3boeWmwl-f7Seo8MV5gGPaYolyo8w_lFVLtdBGN11e9huwwnLqF4wUGtqAbHcuebFi79m5evx_bXkagJMfR6xqZSl0A3UhdKsMtGL_SyAxPz6EhwbTtY7oWANHjY08Msx9WdC5GF0cpXi4h-eS9GA4sfMmh7CCZv7Lu_elTf3lY2oNae4dUF5Fxdr0ktu3Ed5C',
        location: {
          type: 'Point',
    ...
    const foodsData = [
      {
        ...
        description: 'Slow-cooked Jammu red kidney beans in rich aromatic tomato gravy, served with steamed basmati rice and fresh mint chutney.',
        price: 80,
        quantity: 6,
        initialQuantity: 6,
        isVeg: true,
      ...
      },
      {
        ...
        description: 'Soft malai paneer cubes simmered in creamy cashew-tomato makhani gravy, served with 3 soft phulkas.',
        price: 120,
        quantity: 4,
        initialQuantity: 4,
        isVeg: true,
      ...
      },
      {
        ...
        description: 'Golden spiced potato stuffed parathas with fresh homemade white butter, curd, and tangy mango pickle.',
        price: 70,
        quantity: 8,
        initialQuantity: 8,
        isVeg: true,
